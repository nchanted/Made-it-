...
No scenario ever repeats within a single game \u2014 once you've handled every
situation your role can present, you move up. A single climb runs roughly
20\u201345 in-game weeks depending on the path; with three entry tracks, branching
IC and management ladders, and multiple endings and achievements to collect,
seeing it all is several hours of play.
